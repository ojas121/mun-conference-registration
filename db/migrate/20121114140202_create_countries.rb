class CreateCountries < ActiveRecord::Migration
	def self.up
		...
		Country.create( :country_name => 'Bermuda' )
		...
		Country.create( :country_name => 'Brunei Darussalam' )
		...
		Country.create( :country_name => 'Cayman Islands' )
		...
		Country.create( :country_name => 'The Democratic Republic of Congo' )
		Country.create( :country_name => 'Cook Islands' )
		Country.create( :country_name => 'Costa Rica' )
		Country.create( :country_name => 'Cote D\'Ivoire' )
		...
		Country.create( :country_name => 'Falkland Islands (Malvinas)' )
		Country.create( :country_name => 'Faroe Islands' )
		Country.create( :country_name => 'Fiji' )
		Country.create( :country_name => 'Finland' )
		Country.create( :country_name => 'France' )
		Country.create( :country_name => 'French Guiana' )
		Country.create( :country_name => 'French Polynesia' )
		...
		Country.create( :country_name => 'Gibraltar' )
		Country.create( :country_name => 'Greece' )
		Country.create( :country_name => 'Greenland' )
		Country.create( :country_name => 'Grenada' )
		Country.create( :country_name => 'Guadeloupe' )
		Country.create( :country_name => 'Guam' )
		...
		Country.create( :country_name => 'Holy See (Vatican City State)' )
		Country.create( :country_name => 'Honduras' )
		Country.create( :country_name => 'Hong Kong' )
		...
		Country.create( :country_name => 'Islamic Republic of Iran' )
		...
		Country.create( :country_name => 'Democratic People\'s Republic of Korea' )
		Country.create( :country_name => 'Republic of Korea' )
		Country.create( :country_name => 'Kuwait' )
		Country.create( :country_name => 'Kyrgyzstan' )
		Country.create( :country_name => 'Lao People\'s Democratic Republic' )
		...
		Country.create( :country_name => 'Libyan Arab Jamahiriya' )
		Country.create( :country_name => 'Liechtenstein' )
		Country.create( :country_name => 'Lithuania' )
		Country.create( :country_name => 'Luxembourg' )
		Country.create( :country_name => 'Macao' )
		Country.create( :country_name => 'The Former Yugoslav Republic of Macedonia' )
		...
		Country.create( :country_name => 'Netherlands Antilles' )
		Country.create( :country_name => 'New Caledonia' )
		...
		Country.create( :country_name => 'Niue' )
		Country.create( :country_name => 'Norfolk Island' )
		Country.create( :country_name => 'Northern Mariana Islands' )
		...
		Country.create( :country_name => 'Svalbard and Jan Mayen' )
		Country.create( :country_name => 'Swaziland' )
		Country.create( :country_name => 'Sweden' )
		Country.create( :country_name => 'Switzerland' )
		Country.create( :country_name => 'Syrian Arab Republic' )
		Country.create( :country_name => 'Taiwan - Province of China' )
		Country.create( :country_name => 'Tajikistan' )
		Country.create( :country_name => 'United Republic of Tanzania' )
		Country.create( :country_name => 'Thailand' )
		Country.create( :country_name => 'Togo' )
		Country.create( :country_name => 'Tokelau' )
		...
		Country.create( :country_name => 'Turks and Caicos Islands' )
		...
		Country.create( :country_name => 'Viet Nam' )
		Country.create( :country_name => 'Virgin Islands, British' )
		Country.create( :country_name => 'Virgin Islands, U.S.' )
		Country.create( :country_name => 'Wallis and Futuna' )
		Country.create( :country_name => 'Western Sahara' )
